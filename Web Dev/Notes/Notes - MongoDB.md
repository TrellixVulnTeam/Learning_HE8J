...
It's a document database. Stored as **json objects**. (Key: Value pair)
Schemas are optional in MongoDB.

MongoDB Atlas, cloud managed server.

1. Create cluster
2. Create user in database access
